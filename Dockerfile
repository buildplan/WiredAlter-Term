...
FROM node:26.3.0-trixie-slim@sha256:aa27a5fbf5acb298116a38133794f080406c6f8dfe52e2e2836bb55dc7cae8f0 AS builder
...
COPY --from=docker:29.5.2-cli /usr/local/bin/docker /usr/local/bin/
