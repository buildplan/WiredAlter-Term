...
FROM node:26.1.0-trixie-slim@sha256:424cafd2a035ed2b2d74acc3142b68b426fb62a47742c80a75e7117db02d6b30 AS builder
...
COPY --from=docker:29.5.0-cli /usr/local/bin/docker /usr/local/bin/
