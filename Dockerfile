...
# Install NetBird
COPY --from=docker.io/netbirdio/netbird:0.78.0@sha256:4fd5a8877eaa4e1b5950b692ff92e256c6cffde395eaf38c038365a99a12236b /usr/local/bin/netbird /usr/local/bin/netbird
