...
# Install NetBird
COPY --from=docker.io/netbirdio/netbird:0.76.2@sha256:597a57aaf7d92de724996ccd887c2090eda6eccdf733955eb7986ebb652a2560 /usr/local/bin/netbird /usr/local/bin/netbird
