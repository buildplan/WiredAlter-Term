...
# Install NetBird
COPY --from=docker.io/netbirdio/netbird:0.78.1@sha256:c0b492f320e1251ac0655e785fa288e935a0b7b16365d14fdcbc8bf75dc5b0a0 /usr/local/bin/netbird /usr/local/bin/netbird
