...
# Install NetBird
COPY --from=docker.io/netbirdio/netbird:0.76.3@sha256:9f0ad6ae354359926adbd40735fc2cb0be75c786759492abb160a1170544970b /usr/local/bin/netbird /usr/local/bin/netbird
